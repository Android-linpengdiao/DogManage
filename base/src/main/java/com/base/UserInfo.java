...
public class UserInfo implements Serializable, Comparator<FriendBean> {

    public static final int userRank_visitor = 99; //游客
    public static final int userRank_common = 0; //普通用
    public static final int userRank_teacher = 1; //老师
    public static final int userRank_organization = 2; //机构

    public static final int userRank_student = 3; //学生(客户端定义)
    ...
    private long songTestCatalogNum;
    private long allSupportNum;
    private long obtainSupportNum;
    ...
    private long parentUid; //上级UID
    private FriendBean parentUser; //上级

    public FriendBean getParentUser() {
        return parentUser;
    }

    public void setParentUser(FriendBean parentUser) {
    ...
    public long getSongTestCatalogNum() {
        return songTestCatalogNum;
    }

    public void setSongTestCatalogNum(long songTestCatalogNum) {
        this.songTestCatalogNum = songTestCatalogNum;
    }

    public long getAllSupportNum() {
        return allSupportNum;
    }

    public void setAllSupportNum(long allSupportNum) {
        this.allSupportNum = allSupportNum;
    }

    public long getObtainSupportNum() {
        return obtainSupportNum;
    }

    public void setObtainSupportNum(long obtainSupportNum) {
        this.obtainSupportNum = obtainSupportNum;
    }
