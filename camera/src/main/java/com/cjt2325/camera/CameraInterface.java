...
import com.cjt2325.camera.util.AngleUtil;
import com.cjt2325.camera.util.CameraParamUtil;
...
import com.cjt2325.camera.util.DeviceUtil;
...
//                destroyCameraInterface();
    ...
    public Bitmap createFirstFrameBitmap() {
        ...
        firstFrameBitmap = BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
